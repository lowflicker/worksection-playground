...
У плейграунді бокс за замовчуванням 640×640, а не на всю сцену: стіна — це блок на сторінці, і його межі мають бути видні. Тягни за праву, ліву або нижню межу (або став фокус на ручку і тисни стрілки), щоб змінити розмір; потягни за межу сцени — і блок знову її заповнює. Поточний розмір видно в рядку статусу групи «Сітка».
