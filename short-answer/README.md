...
Плейграунд спільний з logo wall: `../index.html`, вкладка «S : Short answer». Збирається тим самим скриптом: `python3 logo-wall/build-playground.py`.
