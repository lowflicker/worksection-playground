...
- телефон завжди зверху (він фізичний об’єкт над екраном), десктоп-мініатюра лежить під ним: велика (55 %), її ліва половина і нижній край видно з-під телефона, як картка в колоді. Тому z-index не перемикається і немає «стрибка» шарів наприкінці;
...
.hero {
  ...
  --hero-desk-s: .55;     --hero-desk-tx: 5cqw;  --hero-desk-ty: 80cqw;
