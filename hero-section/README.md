...
const hero = new Hero('#hero', {
  ...
  fade: 450,           // ms, тривалість зміни скріншота при зміні вкладки
  switch: 'wipe',      // 'wipe' | 'circle' | 'blur' | 'slide' | 'zoom' | 'fade': шторка, коло, крізь розмиття, зсув, з масштабу, кросфейд
