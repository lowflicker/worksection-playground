...
- телефон завжди зверху (він фізичний об’єкт над екраном), десктоп-мініатюра визирає з-під нього. Тому z-index не перемикається і немає «стрибка» шарів наприкінці;
...
const hero = new Hero('#hero', {
  ...
  nudge: true,         // один раз при появі сцени: телефон киває, бейдж пульсує
...
.hero {
  ...
  --hero-stage-h: 124cqw;
  --hero-desk-w: 130cqw;  --hero-desk-x: 5cqw;   --hero-desk-y: 0cqw;
  --hero-desk-s: .4;      --hero-desk-tx: 5cqw;  --hero-desk-ty: 92cqw;
  --hero-phone-w: 52cqw;  --hero-phone-x: 43cqw; --hero-phone-y: 6cqw;
  --hero-phone-s: .77;    --hero-phone-tx: 55cqw; --hero-phone-ty: 36cqw;
}
```

Значення за замовчуванням відштовхуються від мобільного макета Figma (402 px), але десктоп трохи вужчий (130 cqw замість 139), а телефон більший (40 cqw замість 36) і нижчий, щоб майже половина його лежала на фоні секції, а не на білому скріншоті: так мініатюру видно краще. Композицію зручно підбирати в плейграунді, група «Композиція».
